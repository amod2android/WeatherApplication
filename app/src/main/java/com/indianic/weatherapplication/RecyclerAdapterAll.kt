...
class RecyclerAdapterAll(val list: List<RecyclerData>) : RecyclerView.Adapter<RecyclerAdapterAll.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_forecast_all, parent, false)
